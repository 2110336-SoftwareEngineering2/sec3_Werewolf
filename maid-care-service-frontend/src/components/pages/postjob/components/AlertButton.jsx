...
// lbtnName : Left Button Name
// rbtnName : Right Button Name
...
const AlertButton = ({ mainbtnName, mainbtnColor, lbtnName, rbtnName, headerText, bodyText, lbtnFunction, rbtnFunction }) => {
